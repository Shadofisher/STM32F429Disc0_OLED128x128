...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, RDX_Pin|WRX_DCX_Pin|OLED_CS_Pin|OLED_DC_Pin 
  ...
  /*Configure GPIO pins : RDX_Pin WRX_DCX_Pin OLED_CS_Pin OLED_DC_Pin 
                           OLED_RST_Pin */
  GPIO_InitStruct.Pin = RDX_Pin|WRX_DCX_Pin|OLED_CS_Pin|OLED_DC_Pin 
                          |OLED_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
